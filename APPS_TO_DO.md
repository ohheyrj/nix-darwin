...
## Overview
This document tracks macOS applications and their packaging status for Nix/NixOS configuration management.

**Legend:**
- ✅ Available and working in Nix
- 🔄 Available in Nix but needs updates/fixes
...
| Application | Status | Website | Notes |
|-------------|--------|---------|-------|
| VLC | ✅ | https://www.videolan.org/vlc/ | Available in Nix |
| Infuse | 📦 | https://firecore.com/infuse | |
| Prime Video | 📦 | https://www.amazon.com/primevideo | |
| Steam | 📦 | https://store.steampowered.com | |
| MakeMKV | 📦 | https://www.makemkv.com | |
| TuneIn | 📦 | https://tunein.com | |
| Last.fm | ✅ | https://www.last.fm | Available in Nix |
...
| GIMP | ✅ | https://www.gimp.org | Available in Nix |
| Inkscape | ✅ | https://inkscape.org | Available in Nix |
| draw.io | ✅ | https://www.drawio.com | Available in Nix |
...
| Element | 🔄 | https://element.io | Available in Nix but wrong version |
...
#### CLI-Only Available in Nix
| Application | Status | Website | Notes |
|-------------|--------|---------|-------|
| Keybase | 🔄 | https://keybase.io | Only CLI version in Nix, needs GUI packaging |

#### App Store Only
| Application | Status | Website | Notes |
|-------------|--------|---------|-------|
| 1Password for Safari | 🏪 | https://1password.com | App Store exclusive |
| AllMyBatteries | 🏪 | https://allmybatteries.app | App Store exclusive |
| Deliveries | 🏪 | https://junecloud.com/software/mac/deliveries.html | App Store exclusive |
| Flighty | 🏪 | https://flightyapp.com | App Store exclusive |
| iCaching | 🏪 | https://www.geocaching.com | App Store exclusive |
